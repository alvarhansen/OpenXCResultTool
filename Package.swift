        ...
        linkerSettings: [
            .unsafeFlags(
                [
                    ...
                    "-Xlinker", "--export=openxcresulttool_registered_files_json",
                    "-Xlinker", "--export=openxcresulttool_registered_file_base64",
                    ...
                    "-Xlinker", "--export=openxcresulttool_export_object",
                ],
                .when(platforms: [.wasi])
            )
        ]
